    ...
    switch handles.order
        ...
        case 1 
            if wl == 1% Lyzka
                ...
                hMarker_local = findobj(gcf,'Tag','Marker'); set(hMarker_local,...
                    ...
                    'markeredgecolor','black',...
                    'markerfacecolor','r');
                set(handles.opis2,'string','Pobieranie materia³u ³y¿kê z pod³o¿a');
                pause(handles.n*3)
        ...
        case 2 % Przemieszenie
			 ...
			 if wl == 1
				 if probkalyzka >= 1
					...
					pause(handles.n*1)
					set(handles.rozwiazanie,'string','W przeciagu kilku sekund nastapi usuniêcie próbki i pobranie na nowo.');
					pause(handles.n*3)
					set(handles.awaria,'BackgroundColor','default');
        ...
        case 5 % Formowanie porcji
              ...
              if rand <= 0.5
                  ...
                  pause(handles.n*1)
                  set(handles.rozwiazanie,'string','W przeciagu kilku sekund nastapi kolejna próba formowania próbki.');
                  pause(handles.n*3)
                  set(handles.awaria,'BackgroundColor','default');
                  set(handles.opis,'string','');
                  set(handles.rozwiazanie,'string','');
...
handles.cel = menu('Wybierz cel próbki','SAM1','SAM2','CHEMIN','TACKA');
while 1
	...
	handles.sito = menu('Wybierz rozmiar probki','Sito 1mm','Sito 150 mikro metrow');                 
		while 1
			if handles.sito == 1 || handles.sito == 2
				...
				handles.sito = menu('Wybierz rozmiar próbki','Sito 1mm','Sito 150 mikro metrow'); 
			end     
		end
end
	handles.wl = menu('Wybierz Ÿród³o próbki','£y¿ka','Wiert³o'); 
		while 1
